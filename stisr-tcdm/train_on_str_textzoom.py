...
from guided_diffusion.image_datasets import load_data_str_textzoom
...
def load_superres_data(batch_size):
    data = load_data_str_textzoom(batch_size=batch_size)
...
def create_argparser():
    defaults = dict(
        ...
        max_steps=150000, #Added
        ckpt_dir="./ckpt/synthesizer", #Added
    )
