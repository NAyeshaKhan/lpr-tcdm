...
TRAIN_FLAGS="--kb 9 --use_gt_dimss 1 --use_synthesizer 0 --use_degrader 1 --gpu ${gpu} --lr 3e-4 --batch_size 32 --max_steps 150000"
#mpiexec -n 1 python train_on_textzoom.py $TRAIN_FLAGS $MODEL_FLAGS
python train_on_textzoom.py $TRAIN_FLAGS $MODEL_FLAGS --ckpt_dir ./ckpt/degrader