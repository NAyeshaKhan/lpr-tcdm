...
if __name__ == '__main__':
    ...
    # *N: Defines multiple PyTorch dataset classes and loaders for training and testing on the TextZoom and related text image datasets,
    # handling LMDB image reading, preprocessing, normalization, and pairing of low- and high-resolution text images 
    # for SR & OCR tasks.