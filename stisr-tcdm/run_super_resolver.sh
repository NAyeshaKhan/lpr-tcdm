...
#!/bin/bash -e
#For large_size 128 --small_size 64, subpar results. 
...
for ((i=1;i<=$n_iters;i++));
do
    base_samples="./diff_samples/mr_samples/resized-64x128/${num_samples}_samples_${i}.npz"
    out_path="--out_path ./diff_samples/hr_samples/${num_samples}_samples_${i}.npz"
