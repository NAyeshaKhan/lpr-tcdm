...
do
    ...
    args="--level medium --kb 9 --use_gt_dimss 1 --use_synthesizer 1 --gpu ${gpu} --iter ${i} --model_path ${model_path} --num_samples ${num_samples} ${MODEL_FLAGS} ${SAMPLE_FLAGS} ${out_path}"
